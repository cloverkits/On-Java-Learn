...
import static ml.cloverkit.concurrent.CompletableUtilities.showr;
import static ml.cloverkit.concurrent.CompletableUtilities.voidr;
...
public class CompletableOperations {
    ...
    public static void main(String[] args) {
        showr(cfi(1));
        voidr(cfi(2).thenRunAsync(() -> System.out.println("runAsync")));
