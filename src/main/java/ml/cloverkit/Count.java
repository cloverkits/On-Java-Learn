...
public interface Count {
    ...
    char[] CHARS = "abcdefghijklmnopqrestuvwxyz".toCharArray();
    ...
    class Doube implements Supplier<java.lang.Double> {
        private int i;
    ...
    class Pdouble implements DoubleSupplier {
        ...
        public double[] array(int sz) {
            return primitive(new Doube().array(sz));
        }
    }
}
